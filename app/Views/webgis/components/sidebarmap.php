<div class="fixed-content-box" data-hide=true>
    ...
    <div class="fixed-content-body dz-scroll" data-hide=true id="DZ_W_Fixed_Contant">
        <div class="tab-content" id="menu">
            <div class="tab-pane chart-sidebar fade show active" id="dashboard-area" role="tabpanel"></div>
            <div class="tab-pane" id="dashboard" role="tabpanel" style="display: block;">

                <ul class="metismenu tab-nav-menu mb-4">
                    <li class="nav-label">MY LAYERS</li>
                    <!--My List Items -->
                    <?php
                    $datadraw = array("POINT", "LINE", "POLYGON");
                ...
                <ul class="metismenu tab-nav-menu">
                    ...
                    <!-- List Items -->
                    <li style="border-bottom: 1px solid #eee;" class="list-badge">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                    ...
                    <li class="list-badge">
                        ...
                        <ul aria-expanded="false">
                            <?php
                            $datapoi = array("JALAN", "TEMPAT WISASTA", "SUNGAI", "GEOLOGI", "KLHK", "ADMINISTRASI", "BANDARA", "BETING", "DANAU", "DERMAGA", "EMPANG", "IRIGASI", "JEMBATAN", "LANDAS PACU", "PASIR", "PELABUHAN", "RAWA", "TAMBAK", "TERMINAL", "WADUK", "TIANG & PELAMPUNG NAVIGASI")
                            ?>
                            <?php for ($i = 0; $i < 21; $i++) { ?>
                                <?= view("webgis/components/list_item", [
                                    "id" => "poi-" . $i,
