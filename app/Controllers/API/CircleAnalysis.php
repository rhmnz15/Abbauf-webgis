...
class CircleAnalysis extends ResourceController
{
    use ResponseTrait;
    /**
    ...
    public function create()
    {
        ...
        $wkts = $this->request->getVar('wkts');
        $geom = $this->$model->set('geom', "ST_GeomFromText('$wkt')", false);

        $kriteria= $this->request->getVar('fclass');
        $result = array();
